  ...
  <div class="m-user" id="pro-view-0" module-id="module-1" module-launched="true">
   <div class="g-wrap">
    <div class="m-user-frame-wraper">
     <c:set var="member_nav" value="duobao" />
               ...
               <div pro="duobaoList" class="duobaoList">
                     ...
                     <div class="w-goods w-goods-l w-goods-hasLeftPic">
                      ...
                      <c:choose>
                       ...
                       <c:otherwise>
                        ...
                        <p class="w-goods-price">购买时间：<fmt:formatDate value="${item.createTime }" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                       </c:otherwise>
                      </c:choose>
                     </div>
                    </td>
                ...
                <script type="text/javascript">
                 $(".w-pager button").click(function() {
                   window.location="/member/duobao.html?pageNo="+$(this).attr("pageNo");
                 });
                </script>
                </div>
              </div>
