...
<body>
  ...
  <div class="admin-content" id="hl-admin-content">
   ...
   <div class="am-cf am-padding-top-sm">
    <div class="am-u-sm-12 am-u-md-3">
     <div class="am-btn-toolbar am-fl am-padding-left-sm"></div>
    </div>
 ...
 <script src="${mimeBase}/scripts/admin/ygproduct/product_list.js?v=${version}" type="text/javascript"></script>
</body>
</html>