...
public class PubFindPasswordController {
	/** log **/
	private Logger logger = LoggerFactory.getLogger(PubFindPasswordController.class);
	...
	public String resetPassword(ModelAndView model, HttpServletRequest req, HttpServletResponse res, String password, String confirm_password) {
		...
		if (StringUtils.isNoneBlank(sentUsername)) {
			return "/pub/login/resetPassword";
		} else {
			return "/pub/login/findPassword";
		}
	}
